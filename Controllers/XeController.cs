...
namespace DoAnChuyenNganh.Controllers
{
    public class XeController : Controller
    {
        ...
        {
            var lstsp = dbContext.Xes.Where(n => n.KhuVuc.Contains(diachi) && n.MaHinhThucDatXe == 1);
            return View(lstsp.OrderBy(n => n.KhuVuc));
        }
        public ActionResult TimXeTuLai(string diachi)
        {
            var lstsp = dbContext.Xes.Where(n => n.KhuVuc.Contains(diachi) && n.MaHinhThucDatXe == 2);
            return View(lstsp.OrderBy(n => n.KhuVuc));
        }
